...
**Called by:**
- **brainstorming** (Phase 4) - **REQUIRED SUB-SKILL:** Use core:brainstorming when design is approved and implementation follows
- Any skill needing isolated workspace

**Pairs with:**
- **finish-branch** - **REQUIRED SUB-SKILL:** Use workflow:finish-branch for cleanup after work complete
