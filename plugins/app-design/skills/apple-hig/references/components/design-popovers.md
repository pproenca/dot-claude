...
**Avoid using a popover to show a warning.** People can miss a popover or accidentally close it. If you need to warn people, use an [Alerts](https://developer.apple.com/design/human-interface-guidelines/alerts) instead.
