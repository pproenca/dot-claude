...
> **Note:** To learn how the app retrieves and stores earthquake data, see [Maintaining a local copy of server data](https://developer.apple.com/documentation/swiftdata/maintaining-a-local-copy-of-server-data).
...
[image: A screenshot of the sample app running on an iPhone 14 Pro.]
