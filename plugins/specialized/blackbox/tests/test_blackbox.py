...
class TestBlackbox(unittest.TestCase):
    ...
    def test_fast_hash_mmap_empty_file(self):
        ...
        try:
            ...
            self.assertEqual(
                file_hash, "da39a3ee5e6b4b0d3255bfef95601890afd80709", "Empty file SHA1"
            )
    ...
    def test_atomic_store_deduplicates(self):
        ...
        self.assertEqual(
            first_stat.st_mtime, second_stat.st_mtime, "Should not rewrite existing blob"
        )
    ...
    def test_atomic_store_verifies_hash_on_write(self):
        ...
        try:
            ...
            self.assertFalse(
                os.path.exists(blob_path), "Should NOT store when hash mismatches content"
            )
    ...
    def test_atomic_store_blobs_are_immutable(self):
        ...
        self.assertEqual(
            blob_mode, 0o444, f"Blob should be read-only (0o444), got {oct(blob_mode)}"
        )
    ...
    def test_main_pretooluse_write_creates_snapshot(self, mock_stdin):
        ...
        event_data = {
            ...
            "tool_name": "Write",
            "tool_input": {"file_path": self.sample_path},
        }
        ...
        with open(self.blackbox.BUFFER_PATH) as f:
    ...
    def test_main_pretooluse_binary_skipped(self, mock_stdin):
        ...
        event_data = {
            "hook_event_name": "PreToolUse",
            "tool_name": "Edit",
            "tool_input": {"file_path": self.binary_path},
        }
        mock_stdin.read.return_value = json.dumps(event_data)
        ...
        self.assertEqual(
            log_entry.get("skipped"), "binary_or_oversize", "Should mark binary as skipped"
        )
