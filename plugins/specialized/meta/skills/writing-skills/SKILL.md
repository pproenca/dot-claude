...
**REQUIRED SUB-SKILL:** Use core:tdd. You MUST understand the RED-GREEN-REFACTOR cycle defined there. This skill adapts TDD to documentation.
...
Always use subagents (50-100x context savings). **REQUIRED SUB-SKILL:** Use [plugin]:[skill-name] for workflow.
```
...
- ✅ Good: `**REQUIRED SUB-SKILL:** Use core:tdd`
...
**REQUIRED SUB-SKILL:** Use core:tdd. That skill explains why this matters. Same principles apply to documentation.
...
**REQUIRED SUB-SKILL:** Use meta:testing-skills for the complete testing methodology:
