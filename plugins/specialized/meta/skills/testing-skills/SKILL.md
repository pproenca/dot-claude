...
**REQUIRED SUB-SKILL:** Use core:tdd. You MUST understand the RED-GREEN-REFACTOR cycle defined there. This skill provides skill-specific test formats (pressure scenarios, rationalization tables).
