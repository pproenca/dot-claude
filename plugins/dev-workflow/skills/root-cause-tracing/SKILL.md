...
**Core principle:** Trace backward through the call chain until finding the original trigger, then fix at the source.
...
If something appears during tests but the source test is unknown:
