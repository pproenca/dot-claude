...
- **Symbol navigation** — Use cclsp LSP tools for precise code understanding:
...
- **Validate integration points** — Use `mcp__cclsp__find_references` to verify proposed changes won't break existing consumers
