...
[image: A sketch of a person with an overlapping checkmark, suggesting effective collaboration. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.]
...
[image: An illustration of a Notes document on iPhone. The document toolbar prominently features the Share button next to the More button.]
...
[image: An illustration of a Notes document open on iPhone. The document toolbar prominently features the Collaboration button next to the Share button.]
...
[image: An illustration of a Notes document on iPhone. A menu is open from the Collaboration button in the document toolbar, with buttons to display the most recent updates and activities.]
