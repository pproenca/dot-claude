...
[image: A sketch of a half-filled star, suggesting a favorability rating. The image is overlaid with rectangular and circular grid lines and is tinted orange to subtly reflect the orange in the original six-color Apple logo.]
...
[image: An illustration of the UI that appears when a person is prompted to rate an app or game in macOS.]
...
[Ratings, reviews, and responses](https://developer.apple.comhttps://developer.apple.com/app-store/ratings-and-reviews/)
